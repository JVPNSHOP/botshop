#!/usr/bin/env bash
# install_zivpn_bot_fixed_final.sh
# Fixed version with proper menu return after account creation
# Run as root: sudo bash install_zivpn_bot_fixed_final.sh
set -euo pipefail
...
echo "  🏦 Bank: $BANK_NAME"
echo "  🔢 Account: $BANK_NUMBER"
echo "  👤 Holder: $BANK_HOLDER"
echo "  📷 QR Link: ${QR_LINK:-Not set}"
echo ""
echo "📁 Files created:"
...
echo "  systemctl stop zivpn-bot.service"
echo "  systemctl start zivpn-bot.service"
echo ""
echo "✅ Bot is now running! Start chatting with your bot on Telegram."
